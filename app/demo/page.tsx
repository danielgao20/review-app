    ...
    <div className="min-h-screen bg-[#FFFFFF]">
      ...
      <section className="py-12 sm:py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-lg sm:text-2xl font-bold mb-4 sm:mb-6 text-[#111827] leading-tight py-2">
            AI-Powered Review Collection for Local Businesses
          </h2>
          <h1 className="text-xl sm:text-3xl font-bold mb-4 sm:mb-6 text-[#111827] leading-tight py-2">
            Increase Positive Reviews, Decrease Negative Reviews. Rank higher.
          </h1>
          <p className="text-base sm:text-xl text-[#4B5563] mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            <Button size="lg" asChild className="w-full sm:w-auto shadow-lg bg-[#2563EB] hover:bg-[#1D4ED8] text-white">
              <Link href="/auth/signup">Get More Reviews Now</Link>
            </Button>
            <Button variant="outline" size="lg" asChild className="w-full sm:w-auto shadow-lg bg-[#FFFFFF] text-[#2563EB] border-[#2563EB] hover:bg-[#EFF6FF]">
      ...
      <section className="py-12 sm:py-20 bg-[#FFFFFF]">
        <div className="container mx-auto px-4">
          <h3 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12 text-[#111827]">How It Works</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 max-w-6xl mx-auto mb-12 sm:mb-16">
            ...
            <div className="flex flex-col justify-center space-y-3 sm:space-y-4">
              ...
              <h4 className="text-xl sm:text-2xl font-semibold text-[#111827] tracking-tight">Increase Positive Reviews, Decrease Negative Reviews</h4>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 max-w-6xl mx-auto">
            <div className="order-2 md:order-1 flex flex-col justify-center space-y-3 sm:space-y-4">
              <span className="inline-block text-sm font-medium text-[#2563EB]">AI Writing</span>
              <h4 className="text-xl sm:text-2xl font-semibold text-[#111827] tracking-tight">AI-Powered, SEO-Optimized Reviews</h4>
              <p className="text-sm sm:text-base text-[#6B7280] leading-relaxed">
      ...
      <section className="py-12 sm:py-20 bg-[#F9FAFB]">
        <div className="container mx-auto px-4">
          <h3 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12 text-[#111827]">Use Cases</h3>
      ...
      <section className="py-12 sm:py-20">
        <div className="container mx-auto px-4">
          <h3 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12 text-[#111827]">Key Features</h3>
      ...
      <section className="py-12 sm:py-20 bg-[#F9FAFB]">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-[#111827]">Ready to Get Started?</h3>
          ...
          <Button size="lg" asChild className="w-full sm:w-auto bg-[#2563EB] hover:bg-[#1D4ED8] text-white">
